...
def plot_chart(chart_types, path_to_png, path_to_log_list):
...
if __name__ == '__main__':
    if len(sys.argv) < 4:
        ...
        chart_type_strs=sys.argv[1].split(",")
	chart_types=[]
	for chart_t in chart_type_strs:
            chart_type = int(chart_t)
        ...
        plot_chart(chart_types, path_to_png, path_to_logs)
